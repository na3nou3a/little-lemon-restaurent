...
import delevereyIcon from '../../images/deliveryIcon.svg';
function Highlights() {
  return (
    <section className="highlights-section">
      <div className="content max-width">
        <header className="header">
          ...
          <a className="link-btn" href="/menu">
            online menu
          </a>
        </header>
        <div className="body">
          <article className="card">
            ...
            <h3 className="card-title">
              greek salad <span className="card-price">$12.99</span>
            </h3>
          ...
          <article className="card">
            ...
            <h3 className="card-title">
              bruchetta <span className="card-price">$5.99</span>
            </h3>
            <p className="card-description">
          ...
          <article className="card">
            <img className="card-img" src={lemonDessert} alt="lemon desset" />
            <h3 className="card-title">
              lemon desset <span className="card-price">$5.00</span>
            </h3>
            <p className="card-description">
