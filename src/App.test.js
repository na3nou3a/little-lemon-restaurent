...
describe('BookingForm', () => {
  test('it renders BookingForm labels and fields', () => {
    ...
    email: '',
    phone: '',
  }} setFormState={jest.fn()} availableTimes={{bookingSlots: ["17:00", "18:00", "19:00", "20:00", "21:00", "22:00"]}} dispatch={jest.fn(action=> action)} handleSubmit={jest.fn()} />);
...
const handleSubmit=jest.fn()
    ...
    phone: '123456789',
  }} setFormState={jest.fn()} availableTimes={{bookingSlots: ["17:00", "18:00", "19:00", "20:00", "21:00", "22:00"]}} dispatch={jest.fn(action=> action)} handleSubmit={handleSubmit} />);
